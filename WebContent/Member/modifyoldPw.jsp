...
<body>
 ...
 <div>
  	<div> 비밀번호 변경 </div>
  	<form action="./MemberModifyoldPwAction.me" method="post" name="modify" onclick="return checkValue()">
   		<div>
   			<label>현재 비밀번호</label>
   			<input type="password" name="oldPw" id="oldPw" placeholder="현재 비밀번호를 입력하세요">
   		</div>
   		<div>
   			<label>새 비밀번호</label>
