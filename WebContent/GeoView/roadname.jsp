...
<input type="text" name="latitude" id="latitude" value="" placeholder="위도"/>
<input type="text" name="longitude" id="longitude" value="" placeholder="경도"/>
</form>
...
var distanceGap  = document.getElementById("distance");
    ...
    var marker = new daum.maps.Marker({
        position: new daum.maps.LatLng(35.85659647224101, 128.53115388420585),
        title: "마커1",
        map: map
    });
